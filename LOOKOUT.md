<div align="center">
  <img src="./public/logo.svg" alt="Lookout" width="320" />
...
It only surfaces an alert when **both** clear the bar. The longer it runs, the quieter and sharper it gets, because its memory of "what you've already seen" keeps growing. The single coral dot in our logo is the point: **one alert that matters**, out of all the noise it silenced.
...
## How the three sponsor technologies are used
...
```
See `INTEGRATION.md` for the full REST + WebSocket contract.
...
src/                 # Vite dashboard (Search · Stay · Notify)
  api/index.js       # the mock↔real seam (see INTEGRATION.md)
